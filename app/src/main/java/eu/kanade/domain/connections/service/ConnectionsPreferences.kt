...
class ConnectionsPreferences(
    ...
    companion object {
        ...
        fun connectionsUsername(syncId: Long) = "pref_manga_connections_username_$syncId"

        private fun connectionsPassword(syncId: Long) = "pref_manga_connections_password_$syncId"
