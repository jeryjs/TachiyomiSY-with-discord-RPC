    ...
    override fun getPreferences(): List<Preference> {
        ...
        return listOf(
            Preference.PreferenceGroup(
                title = stringResource(SYMR.strings.special_services),
                preferenceItems = persistentListOf(
                    Preference.PreferenceItem.ConnectionsPreference(
                        title = stringResourceInt(connectionsManager.discord.nameRes()),
                    ...
                    Preference.PreferenceItem.InfoPreference(stringResource(SYMR.strings.connections_discord_info)),
                    Preference.PreferenceItem.InfoPreference(stringResource(SYMR.strings.connections_info)),
                ),
            ),
        )
    }
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text(
                        text = stringResource(
                            ...
                            stringResourceInt(service.nameRes()),
                        ),
...
internal fun ConnectionsLogoutDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(
                text = stringResource(MR.strings.logout_title, stringResourceInt(service.nameRes())),
