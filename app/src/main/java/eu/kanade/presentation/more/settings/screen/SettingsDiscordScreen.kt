...
object SettingsDiscordScreen : SearchableSettings {
    ...
    @ReadOnlyComposable
    @Composable
    override fun getTitleRes() = SYMR.strings.pref_category_connections
    ...
    override fun getPreferences(): List<Preference> {
        ...
        return listOf(
            Preference.PreferenceGroup(
                title = stringResource(SYMR.strings.connections_discord),
                preferenceItems = persistentListOf(
                    Preference.PreferenceItem.SwitchPreference(
                        pref = enableDRPCPref,
                        title = stringResource(SYMR.strings.pref_enable_discord_rpc),
                    ),
                    Preference.PreferenceItem.SwitchPreference(
                        pref = useChapterTitlesPref,
                        enabled = enableDRPC,
                        title = stringResource(SYMR.strings.show_chapters_titles_title),
                        subtitle = stringResource(SYMR.strings.show_chapters_titles_subtitle),
                    ),
                    Preference.PreferenceItem.ListPreference(
                        pref = discordRPCStatus,
                        title = stringResource(SYMR.strings.pref_discord_status),
                        entries = persistentMapOf(
                            -1 to stringResource(SYMR.strings.pref_discord_dnd),
                            0 to stringResource(SYMR.strings.pref_discord_idle),
                            1 to stringResource(SYMR.strings.pref_discord_online),
                        ),
                        enabled = enableDRPC,
                    ),
                ),
    ...
    private fun getRPCIncognitoGroup(
        ...
        if (showDialog) {
            TriStateListDialog(
                title = stringResource(SYMR.strings.general_categories),
                message = stringResource(SYMR.strings.pref_discord_incognito_categories_details),
                items = allCategories,
        ...
        return Preference.PreferenceGroup(
            ...
            preferenceItems = persistentListOf(
                Preference.PreferenceItem.SwitchPreference(
                    ...
                    title = stringResource(SYMR.strings.pref_discord_incognito),
                    subtitle = stringResource(SYMR.strings.pref_discord_incognito_summary),
                ),
                Preference.PreferenceItem.TextPreference(
                    title = stringResource(SYMR.strings.general_categories),
                ...
                Preference.PreferenceItem.InfoPreference(stringResource(SYMR.strings.pref_discord_incognito_categories_details)),
            ),
            enabled = enabled,
        )
    }
