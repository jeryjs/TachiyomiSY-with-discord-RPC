...
enum class DiscordScreen(
    ...
    @StringRes val state: Int = R.string.connections_discord,
    val imageUrl: String,
) {
    APP(R.string.fancy_rpc_name, R.string.browsing, R.string.label_library, tachiyomisyImageUrl),
    LIBRARY(R.string.fancy_rpc_name, R.string.browsing, R.string.label_library, libraryImageUrl),
    UPDATES(R.string.fancy_rpc_name, R.string.scrolling, R.string.label_recent_updates, updatesImageUrl),
    HISTORY(R.string.fancy_rpc_name, R.string.scrolling, R.string.label_recent_manga, historyImageUrl),
    BROWSE(R.string.fancy_rpc_name, R.string.browsing, R.string.label_sources, browseImageUrl),
    MORE(R.string.fancy_rpc_name, R.string.messing, R.string.label_settings, moreImageUrl),
    WEBVIEW(R.string.fancy_rpc_name, R.string.browsing, R.string.action_web_view, webviewImageUrl),
    COMIC(R.string.fancy_rpc_name, R.string.fancy_rpc_reading, R.string.comic, comicImageUrl),
}

// Constants for standard Rich Presence image urls
private const val tachiyomisyImageUrl = "emojis/1229456525026787409.webp?quality=lossless"
private const val libraryImageUrl = "emojis/1229715144762720256.webp?quality=lossless"
